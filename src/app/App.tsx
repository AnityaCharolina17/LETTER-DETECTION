    ...
    <div className="size-full bg-gradient-to-br from-blue-50 to-cyan-50 p-4">
      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-4 h-[calc(100vh-140px)]">
        ...
        <div className="bg-white rounded-xl shadow-lg border-2 border-blue-300 p-3 overflow-y-auto">
          <h3 className="text-xs font-bold text-blue-900 mb-2">🎨 Kontrol</h3>

          {/* Mode Selection */}
          <div className="mb-2">
            <label className="block text-xs font-bold mb-1 text-gray-700">Pilih Alat</label>
          ...
          {/* Detection Type */}
          <div className="mb-2">
            <label className="block text-xs font-bold mb-1 text-gray-700">Tipe Deteksi</label>
            <div className="grid grid-cols-2 gap-2">
              <button
